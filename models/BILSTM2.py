...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        # Project embedding to match BiLSTM output
        ...
        self.encoder_lstm = nn.LSTM(
            input_size=configs.d_model * 2,  # Updated input size
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        enc_input = self.enc_embed_projection(enc_input)  # Project to 2 * d_model
